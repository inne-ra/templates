      ...
      <html class="no-js lt-ie9" lang="">
         ...
         <html class="no-js" lang="en">
            ...
            <body>
               ...
               <!-- End Navigation -->
          <!-- Banner -->
         <section class="inner-intro dark-bg bg bg-fixed overlay jarallax" data-jarallax='{"speed": 0.3}' data-overlay-color="dark" data-overlay="2" data-bg-img="images/banner.jpg')}}" >
            <div class="container">
