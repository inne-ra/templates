               ...
               <nav class="navbar navbar-default navbar-sidebar bootsnav no-full">
                  ...
                  <div class="container">
                     ...
                     <div class="navbar-header">
                        ...
                        <a class="navbar-brand mb-7" href="index-default"><img src="{{ asset('templates/kkr021/images/brand/logo-black.png')}}" class="logo logo-scrolled" alt=""> </a> 
                     </div>
            ...
            <div class="container">
               <div class="row intro-title">
                  <div class="col-sm-12 text-left">
                     <h1 class="title text-white">Header Side Left</h1>
                  </div>
                  <div class="col-sm-12">
                     <div class="row">
                        ...
                        <div class="col-sm-6 text-right">
                           <ul class="page-breadcrumb">
                              ...
                              <li><span class="theme-text">Header Side Left</span> </li>
                           </ul>
                        </div>
                     </div>
                  </div>
