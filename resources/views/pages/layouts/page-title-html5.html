      ...
      <html class="no-js lt-ie9" lang="">
         ...
         <html class="no-js" lang="en">
            ...
            <body>
               ...
               <!-- End Navigation -->
         <!-- Banner -->
         <section class="inner-intro dark-bg overlay jarallax" data-overlay-color="dark" data-overlay="8" data-bg-img="video/video.jpg')}}"  data-jarallax='{"type": "scroll-opacity"}' data-jarallax-video='mp4:video/video.mp4' >
            <div class="container">
               <div class="row intro-title">
                  <div class="col-sm-12 text-left">
                     <h1 class="title text-white">HTML5 Video</h1>
                  </div>
                  <div class="col-sm-12">
                     <div class="row">
                        ...
                        <div class="col-sm-6 text-right">
                           <ul class="page-breadcrumb">
                              ...
                              <li><a href="javascript:void(0)">Page Tittle</a></li>
                              <li><a href="javascript:void(0)">Video</a></li>
                              <li><span class="theme-text">HTML5 Video</span> </li>
                           </ul>
                        </div>
                     </div>
                  </div>
