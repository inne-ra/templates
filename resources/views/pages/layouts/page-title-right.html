            ...
            <div class="container">
               <div class="row intro-title">
                  <div class="col-sm-12 text-right">
                     <h1 class="title text-white">Align Right</h1>
                  </div>
                  <div class="col-sm-12">
                     <div class="row">
                        <div class="col-sm-6 col-sm-push-6 text-right"><span class="sub-title">Subtittle Goes Here</span></div>
                        <div class="col-sm-6 col-sm-pull-6 text-left">
                           <ul class="page-breadcrumb">
                              <li><a href="javascript:void(0)">Features</a></li>
                              <li><a href="javascript:void(0)">Page Tittle</a></li>
                              <li><a href="javascript:void(0)">Alignment</a></li>
                              <li><span class="theme-text">Align Right</span> </li>
                           </ul>
                        </div>
                     </div>
                  </div>
