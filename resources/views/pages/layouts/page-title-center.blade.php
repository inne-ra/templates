            ...
            <div class="container">
               <div class="row intro-title">
                  <div class="col-sm-12 text-center">
                     <h1 class="title text-white">Align Center</h1>
                  </div>
                  <div class="col-sm-12">
                     <div class="row">
                        <div class="col-sm-12 text-center"><span class="sub-title">Subtittle Goes Here</span></div>
                        <div class="col-sm-12 text-center mt-1">
                           <ul class="page-breadcrumb">
                              ...
                              <li><span class="theme-text">Align Center</span> </li>
                           </ul>
                        </div>
                     </div>
                  </div>
