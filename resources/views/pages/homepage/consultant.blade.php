      ...
      <html class="no-js lt-ie9" lang="">
         ...
         <html class="no-js" lang="en">
            ...
            <head>
               ...
               <!-- Skin -->
               <link rel="stylesheet" href="{{ asset('templates/kkr021/css/skin-consultant.css')}}" type="text/css"/>
               <!-- Favicon -->
            ...
            <body>
               ...
               <section class="full-height fullscreen bg white-text header-slide">
                  <div class="owl-carousel owl-theme light-arrow" data-items="1" data-md-items="1" data-sm-items="1" data-nav-dots="false" data-nav-arrow="true" data-auto-play="false"  data-space="0">
                     <!-- item -->
                     <div class="item"  >
                        <div class="slide-img"><img src="{{ asset('templates/kkr021/images/consultant/slide3.jpg')}}" alt="" /></div>
                        <div class="container">
                           <div class="row">
                              <div class="col-md-8">
                     ...
                     <!-- item -->
                     <div class="item" >
                        <div class="slide-img"><img src="{{ asset('templates/kkr021/images/consultant/slide2.jpg')}}" alt="" /></div>
                        <div class="container">
                           <div class="row">
                     ...
                     <!-- item -->
                     <div class="item"  >
                        <div class="slide-img"><img src="{{ asset('templates/kkr021/images/consultant/slide1.jpg')}}" alt="" /></div>
                        <div class="container">
                           <div class="row">
                              <div class="col-md-8">
               ...
               <section class="grey-bg section-sm">
                  <div class="container">
                     <div class="row">
                        ...
                        <div class="col-md-6">
                           <div class="row mt-2">
                           		<div class="col-md-12 col-sm-8 mb-2"><img src="{{ asset('templates/kkr021/images/consultant/image1.jpg')}}" class="img-responsive" alt="" /></div>
                  ...
                  <div class="container">
                     ...
                     <div class="col-sm-12">
                        <div class="owl-carousel owl-theme c-theme" data-items="3" data-nav-dots="true"  data-space="40">
                           <div class="item">
                              <div class="mb-4"><img src="{{ asset('templates/kkr021/images/consultant/image2.jpg')}}" class="img-responsive" alt="what-we-offer" /></div>
                           ...
                           <div class="item">
                              <div class="mb-4"><img src="{{ asset('templates/kkr021/images/consultant/image3.jpg')}}" class="img-responsive" alt="what-we-offer" /></div>
                              <p class="mb-0 theme-text solid-weight">FINANCE</p>
                              <h5 class="mb-1">Stock Market Consulting</h5>
                              <p class="mb-0">The clients are mostly the companies dealing with said products or services, but we also enjoy teaming up with other agencies, companies with great ideas. </p>
                           </div>
                           <div class="item">
                              <div class="mb-4"><img src="{{ asset('templates/kkr021/images/consultant/image4.jpg')}}" class="img-responsive" alt="what-we-offer" /></div>
                              <p class="mb-0 theme-text solid-weight">FINANCE</p>
                              <h5 class="mb-1">Wealth Management Consulting</h5>
                              <p class="mb-0">The clients are mostly the companies dealing with said products or services, but we also enjoy teaming up with other agencies, companies with great ideas. </p>
                           </div>
                           <div class="item">
                              <div class="mb-4"><img src="{{ asset('templates/kkr021/images/consultant/image5.jpg')}}" class="img-responsive" alt="what-we-offer" /></div>
                           ...
                           <div class="item">
                              <div class="mb-4"><img src="{{ asset('templates/kkr021/images/consultant/image6.jpg')}}" class="img-responsive" alt="what-we-offer" /></div>
                              <p class="mb-0 theme-text solid-weight">BRANDING</p>
                              <h5 class="mb-1">Strategy & Consulting</h5>
                              <p class="mb-0">The clients are mostly the companies dealing with said products or services, but we also enjoy teaming up with other agencies, companies with great ideas. </p>
                           </div>
               ...
               <section class="p-0 pos-r grey-bg">
                  <div class="fullbg bg-pos-right" data-bg-img="{{ asset('templates/kkr021/images/consultant/bg1.jpg')}}"></div>
                  <div class="container">
                     <div class="row ">
               ...
               <section class="pos-r p-0">
                  <div class="fullbg bg-pos-right" data-bg-img="{{ asset('templates/kkr021/images/consultant/bg2.jpg')}}" ></div>
                  <div class="container">
                     <div class="row">
               ...
               <!-- Clients --> 
               <section class="pos-r p-0">
                  <div class="fullbg bg-left-pos" data-bg-img="{{ asset('templates/kkr021/images/consultant/bg3.jpg')}}" ></div>
                  <div class="container">
                     <div class="row">
                           ...
                           <div class="py-7 pl-7 xs-py-4 sm-py-5 sm-pl-5 xs-pl-1 xs-big-mt">
                              ...
                              <div class="row">
                                 <div class="col-sm-12"><div class="clients line">
                                    ...
                                    <div class="col-sm-4 col-xs-6 col-xx-12">
                                       <div class="media"><img class="img-responsive" src="{{ asset('templates/kkr021/images/clients/logo4.png')}}" alt=""></div>
                                    </div>
                                    <div class="col-sm-4 col-xs-6 col-xx-12">
                                       <div class="media"><img class="img-responsive" src="{{ asset('templates/kkr021/images/clients/logo5.png')}}" alt=""></div>
                                    </div>
                                    <div class="col-sm-4 col-xs-6 col-xx-12">
                                       <div class="media"><img class="img-responsive" src="{{ asset('templates/kkr021/images/clients/logo1.png')}}" alt=""></div>
                                    </div>
