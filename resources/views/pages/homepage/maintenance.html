   ...
   <html lang="en">
	  ...
	  <!-- maintenance -->
         <section class="maintenance-page darks-bg p-0 full-height" data-bg-img="images/maintenance-bg.jpg">
            ...
            <div class="container">
               <div class="row">
                  <div class="maintenance-block col-md-8 col-md-offset-2 col-sm-12 text-center">
				  <div class="valign-middle">
                     <a class="m-logo" href="#"><img class="mb-3" src="{{ asset('templates/kkr021/images/brand/logo.png')}}" width="120" alt=""></a>
					 <h3 class="text-uppercase whites-text mb-1">The website is in maintenance mode.</h3>
					 <h5 class="text-uppercase whites-text">Please Check Back in Sometime.</h5>
					 <div class="col-sm-8 col-sm-offset-2">
					<form role="form" class="search-form">
							<div class="form-group">
							   <input name="search" class="form-control" placeholder="Notify Me" type="text">
							   <a href="#" class="btn btn-sm btn-default btn-radius icon-left hover-effect1 mt-2"><i class="fa fa fa-bell-o" aria-hidden="true"></i> Notify Me</a>
