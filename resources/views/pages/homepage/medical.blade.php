      ...
      <html class="no-js lt-ie9" lang="">
         ...
         <html class="no-js" lang="en">
            ...
            <head>
               ...
               <!-- Datetimepicker -->
               <link rel="stylesheet" href="{{ asset('templates/kkr021/css/bootstrap-datetimepicker.min.css')}}" type="text/css" />
               <!-- base -->
               ...
               <!-- Skin -->
               <link rel="stylesheet" href="{{ asset('templates/kkr021/css/skin-medical.css')}}" type="text/css"/>
               <!-- Favicon -->
            ...
            <body>
               ...
               <section class="full-height fullscreen header-slide">
                  <div class="owl-carousel owl-theme light-arrow" data-items="1" data-md-items="1" data-sm-items="1" data-nav-dots="false" data-nav-arrow="true" data-auto-play="false"  data-space="0">
                     <div class="item" >
                        <div class="slide-img"><img src="{{ asset('templates/kkr021/images/medical/slide2.jpg')}}" alt=""></div>
                        <div class="container">
                           <div class="row">
                     ...
                     <div class="item"  >
                        <div class="slide-img"><img src="{{ asset('templates/kkr021/images/medical/slide1.jpg')}}" alt=""></div>
                        <div class="container">
                           <div class="row">
                     ...
                     <div class="item overlay" >
                        <div class="slide-img" ><img src="{{ asset('templates/kkr021/images/medical/slide3.jpg')}}" alt=""></div>
                        <div class="container">
                           <div class="row">
                              <div class="col-md-12 text-right">
                     ...
                     <div class="row row-eq-height sm-row-eq-height no-gutter">
                        <div class="col-md-4 col-lg-4" data-bg-color="#4f7cda">
                           <div class="py-5 px-7 sm-pxy-3 white-text">
                              ...
                              <div class="separator"><img src="{{ asset('templates/kkr021/images/medical/wave-divider.png')}}" alt="" /></div>
               ...
               <section class="bg" data-bg-img="images/medical/bg1.jpg">
                  <div class="container">
                     <div class="row mb-3">
                        ...
                        <div class="col-md-6 ">
                           <div class="video-info"> <img class="img-responsive center-block" src="{{ asset('templates/kkr021/images/medical/image1.jpg')}}" alt=""> <a class="popup-vimeo theme-bg" href="video/video.mp4"><i class="icon-control-play icons"></i></a> </div>
                        </div>
                     </div>
                     <div class="row">
                        <div class="col-md-10">
                              ...
                              <ul class="b-isotope-grid grid list-unstyled columns3">
                                 ...
                                 <li class="grid-item design">
                                    <div class="isotope-img portfolio-item">
                                       <div class="item-img">
                                          <div class="overlay"> <a class="link-icon popup-img" href="{{ asset('templates/kkr021/images/portfolio/design/img1.jpg')}}"><i class="lnr lnr-picture"></i></a> <a class="link-icon" href="#"><i class="lnr lnr-link"></i></a> </div>
                                 ...
                                 <li class="grid-item photo">
                                    <div class="isotope-img portfolio-item">
                                       <div class="item-img">
                                          <div class="overlay"> <a class="link-icon popup-img" href="{{ asset('templates/kkr021/images/portfolio/photo/img1.jpg')}}"><i class="lnr lnr-picture"></i></a> <a class="link-icon" href="#"><i class="lnr lnr-link"></i></a> </div>
                                 ...
                                 <li class="grid-item branding">
                                    <div class="isotope-img portfolio-item">
                                       <div class="item-img">
                                          <div class="overlay"> <a class="link-icon popup-img" href="{{ asset('templates/kkr021/images/portfolio/branding/img1.jpg')}}"><i class="lnr lnr-picture"></i></a> <a class="link-icon" href="#"><i class="lnr lnr-link"></i></a> </div>
                                 ...
                                 <li class="grid-item app">
                                    <div class="isotope-img portfolio-item">
                                       <div class="item-img">
                                          <div class="overlay"> <a class="link-icon popup-img" href="{{ asset('templates/kkr021/images/portfolio/app/img1.jpg')}}"><i class="lnr lnr-picture"></i></a> <a class="link-icon" href="#"><i class="lnr lnr-link"></i></a> </div>
                                 ...
                                 <li class="grid-item design">
                                    <div class="isotope-img portfolio-item">
                                       <div class="item-img">
                                          <div class="overlay"> <a class="link-icon popup-img" href="{{ asset('templates/kkr021/images/portfolio/design/img2.jpg')}}"><i class="lnr lnr-picture"></i></a> <a class="link-icon" href="#"><i class="lnr lnr-link"></i></a> </div>
                                 ...
                                 <li class="grid-item photo">
                                    <div class="isotope-img portfolio-item">
                                       <div class="item-img">
                                          <div class="overlay"> <a class="link-icon popup-img" href="{{ asset('templates/kkr021/images/portfolio/photo/img2.jpg')}}"><i class="lnr lnr-picture"></i></a> <a class="link-icon" href="#"><i class="lnr lnr-link"></i></a> </div>
                                 ...
                                 <li class="grid-item branding">
                                    <div class="isotope-img portfolio-item">
                                       <div class="item-img">
                                          <div class="overlay"> <a class="link-icon popup-img" href="{{ asset('templates/kkr021/images/portfolio/branding/img3.jpg')}}"><i class="lnr lnr-picture"></i></a> <a class="link-icon" href="#"><i class="lnr lnr-link"></i></a> </div>
                                 ...
                                 <li class="grid-item app">
                                    <div class="isotope-img portfolio-item">
                                       <div class="item-img">
                                          <div class="overlay"> <a class="link-icon popup-img" href="{{ asset('templates/kkr021/images/portfolio/app/img3.jpg')}}"><i class="lnr lnr-picture"></i></a> <a class="link-icon" href="#"><i class="lnr lnr-link"></i></a> </div>
                                 ...
                                 <li class="grid-item design">
                                    <div class="isotope-img portfolio-item">
                                       <div class="item-img">
                                          <div class="overlay"> <a class="link-icon popup-img" href="{{ asset('templates/kkr021/images/portfolio/design/img3.jpg')}}"><i class="lnr lnr-picture"></i></a> <a class="link-icon" href="#"><i class="lnr lnr-link"></i></a> </div>
                                 ...
                                 <li class="grid-item photo">
                                    <div class="isotope-img portfolio-item">
                                       <div class="item-img">
                                          <div class="overlay"> <a class="link-icon popup-img" href="{{ asset('templates/kkr021/images/portfolio/photo/img3.jpg')}}"><i class="lnr lnr-picture"></i></a> <a class="link-icon" href="#"><i class="lnr lnr-link"></i></a> </div>
                                 ...
                                 <li class="grid-item app">
                                    <div class="isotope-img portfolio-item">
                                       <div class="item-img">
                                          <div class="overlay"> <a class="link-icon popup-img" href="{{ asset('templates/kkr021/images/portfolio/app/img2.jpg')}}"><i class="lnr lnr-picture"></i></a> <a class="link-icon" href="#"><i class="lnr lnr-link"></i></a> </div>
                                 ...
                                 <li class="grid-item branding">
                                    <div class="isotope-img portfolio-item">
                                       <div class="item-img">
                                          <div class="overlay"> <a class="link-icon popup-img" href="{{ asset('templates/kkr021/images/portfolio/branding/img4.jpg')}}"><i class="lnr lnr-picture"></i></a> <a class="link-icon" href="#"><i class="lnr lnr-link"></i></a> </div>
               ...
               <section class="dark-bg theme-bg p-0 mt-3">
                  <div class="container">
                     <div class="row">
                                 ...
                                 <div class="carousel-inner" role="listbox">
                                    <div class="item active">
                                       <div class="author-description">
                                          ...
                                          <div class="author-info">
                                             <div class="author-img"><img class="img-responsive" src="{{ asset('templates/kkr021/images/testimonials/image1.jpg')}}" alt=""></div>
                                    ...
                                    <div class="item">
                                       <div class="author-description">
                                          ...
                                          <div class="author-info">
                                             <div class="author-img"><img class="img-responsive" src="{{ asset('templates/kkr021/images/testimonials/image2.jpg')}}" alt=""></div>
                                             <span class="author-name">- John Doe, Company CEO</span> 
                                          </div>
                                       </div>
                                    </div>
                                    <div class="item">
                                       <div class="author-description">
                                          ...
                                          <div class="author-info">
                                             <div class="author-img"><img class="img-responsive" src="{{ asset('templates/kkr021/images/testimonials/image3.jpg')}}" alt=""></div>
                                             <span class="author-name">- John Doe, Company CEO</span> 
                                          </div>
                                       </div>
                                    </div>
                        ...
                        <div class="col-md-5">
                           <div class="image-block text-center visible-md visible-lg doctor-img"><img class="img-responsive" style="display:inline" src="{{ asset('templates/kkr021/images/medical/doctor-img.png')}}" alt=""></div>
                        </div>
                     </div>
                  </div>
               </section>
                     ...
                     <div class="row gutter-10">
                        ...
                        <div class="item">
                           <div class="team team-3">
                              <div class="member-image clearfix"> <a class="arrow-btn" href="#"><i class="lnr lnr-arrow-right"></i></a> <img class="img-responsive" src="{{ asset('templates/kkr021/images/medical/member1.jpg')}}" alt="" /></div>
                              <div class="team-info">
                        ...
                        <div class="item">
                           <div class="team team-3">
                              <div class="member-image clearfix"> <a class="arrow-btn" href="#"><i class="lnr lnr-arrow-right"></i></a> <img class="img-responsive" src="{{ asset('templates/kkr021/images/medical/member2.jpg')}}" alt="" /></div>
                              <div class="team-info">
                        ...
                        <div class="item">
                           <div class="team team-3">
                              <div class="member-image clearfix"> <a class="arrow-btn" href="#"><i class="lnr lnr-arrow-right"></i></a> <img class="img-responsive" src="{{ asset('templates/kkr021/images/medical/member3.jpg')}}" alt="" /></div>
                              <div class="team-info">
                        ...
                        <div class="item">
                           <div class="team team-3">
                              <div class="member-image clearfix"> <a class="arrow-btn" href="#"><i class="lnr lnr-arrow-right"></i></a> <img class="img-responsive" src="{{ asset('templates/kkr021/images/medical/member4.jpg')}}" alt="" /></div>
                              <div class="team-info">
               ...
               <!-- Datetimepicker -->
               <script src="{{ asset('templates/kkr021/js/datetimepicker/moment.min.js')}}"></script>
               <script src="{{ asset('templates/kkr021/js/datetimepicker/bootstrap-datetimepicker.min.js')}}"></script>
               <!-- Bootsnavs -->
