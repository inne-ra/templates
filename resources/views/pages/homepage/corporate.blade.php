      ...
      <html class="no-js lt-ie9" lang="">
         ...
         <html class="no-js" lang="en">
            ...
            <head>
               ...
               <!-- Skin -->
               <link rel="stylesheet" href="{{ asset('templates/kkr021/css/skin-corporate.css')}}" type="text/css"/>
               <!-- Favicon -->
            ...
            <body>
               ...
               <!-- End Navigation -->
               <!-- Banner -->
               <section class="full-height bg white-text header-slide single-image overlay" data-overlay-color="dark" data-overlay="8" data-bg-img="{{ asset('templates/kkr021/images/corporate/banner.jpg')}}" data-jarallax-video="https://www.youtube.com/watch?v=SF4aHwxHtZ0">
                  <div class="container">
                     <div class="row">
               ...
               <section>
                  <div class="container">
                     ...
                     <div class="row">
                        ...
                        <div class="col-sm-6">
                           <div class="video-info"> <img class="img-responsive center-block" src="{{ asset('templates/kkr021/images/corporate/image1.jpg')}}" alt="" /> <a class="popup-vimeo video-btn theme-bg" title="Video" href="video/video.mp4"><i class="icon-control-play icons"></i></a> </div>
                           <div class="row mt-3">
               ...
               <section class="p-0 pos-r white-bg">
                  <div class="fullbg" data-bg-img="{{ asset('templates/kkr021/images/corporate/bg1.jpg')}}" ></div>
                  <div class="container">
               ...
               <section class="p-0 dark-bg pos-r">
                  <div class="fullbg bg-pos-right" data-bg-img="{{ asset('templates/kkr021/images/corporate/bg2.jpg')}}" ></div>
                  <div class="container">
                     <div class="row">
               ...
               <section>
                  <div class="container">
                     ...
                     <div class="row mt-4">
                        <div class="col-md-5"> <img src="{{ asset('templates/kkr021/images/corporate/image2.jpg')}}" class="img-responsive" alt="" /> </div>
                        <div class="col-md-7 mt-1">
                           ...
                           <p class="text-right mb-0"><img src="{{ asset('templates/kkr021/images/Signature.png')}}" alt="" /></p>
                        </div>
                     </div>
                  </div>
               </section>
               ...
               <div class="row no-gutter">
                  ...
                  <div class="col-md-9 col-sm-12">
                     <div class="owl-carousel owl-theme light-arrow" data-items="3" data-md-items="3" data-sm-items="3" data-xs-items="2" data-nav-dots="false" data-nav-arrow="false" data-auto-play="true"  data-space="0">
                        <div class="item">
                           <div class="team">
                              <div class="member-image clearfix"> <a class="arrow-btn" href="#"><i class="lnr lnr-arrow-right"></i></a> <img class="img-responsive" src="{{ asset('templates/kkr021/images/corporate/member1.jpg')}}" alt="" /></div>
                              <div class="team-info">
                        ...
                        <div class="item">
                           <div class="team">
                              <div class="member-image clearfix"> <a class="arrow-btn" href="#"><i class="lnr lnr-arrow-right"></i></a> <img class="img-responsive" src="{{ asset('templates/kkr021/images/corporate/member2.jpg')}}" alt="" /></div>
                              <div class="team-info">
                        ...
                        <div class="item">
                           <div class="team">
                              <div class="member-image clearfix"> <a class="arrow-btn" href="#"><i class="lnr lnr-arrow-right"></i></a> <img class="img-responsive" src="{{ asset('templates/kkr021/images/corporate/member3.jpg')}}" alt="" /></div>
                              <div class="team-info">
