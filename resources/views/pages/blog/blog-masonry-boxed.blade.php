...
<html lang="en" class="ie9">
   ...
   <html lang="en">
      ...
      <body>
         ...
         <!-- End Navigation -->
         <section class="inner-intro dark-bg bg overlay jarallax" data-jarallax='{"speed": 0.2}' data-overlay-color="dark" data-overlay="2" data-bg-img="{{ asset('templates/kkr021/images/banner.jpg')}}" >
            <div class="container">
               <div class="row intro-title">
                  <div class="col-sm-12 text-left">
                     <h1 class="title text-white">Blog Masonry Boxed</h1>
                  </div>
                  <div class="col-sm-12">
                     <div class="row">
                        ...
                        <div class="col-sm-6 text-right">
                           <ul class="page-breadcrumb">
                              ...
                              <li><span class="theme-text">Blog Boxed</span> </li>
                           </ul>
                        </div>
                     </div>
                  </div>
