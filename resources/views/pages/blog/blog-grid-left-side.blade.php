   ...
   <html lang="en">
      ...
      <body class="blog-with-sidebar">
         ...
         <nav class="navbar navbar-default navbar-fixed white  no-background bootsnav on no-full">
            ...
            <!-- End Top Search -->
            <div class="container-fuild px-3 py-1">
            ...
            <div class="container-fluid">
               <div class="row intro-title">
                  <div class="col-sm-12 text-left">
                     <h1 class="title text-white">Blog Left Sidebar</h1>
                  </div>
                  <div class="col-sm-12">
                     <div class="row">
                        ...
                        <div class="col-sm-6 text-right">
                           <ul class="page-breadcrumb">
                              ...
                              <li><span class="theme-text">Blog Left Sidebar</span> </li>
                           </ul>
                        </div>
                     </div>
                  </div>
         ...
         <section class="masonry-main blog-post"">
            <div class="container-fluid">
               <div class="row row-eq-height">
                  <div class="col-md-9 col-sm-12 col-md-push-3 sm-mb-2">
                     <div class="masonry blog-masonry column-3">
                        <div class="masonry-item">
                           <div class="post post-over">
                              <div class="post-image clearfix"> <i class="lnr lnr-camera"></i> <img class="img-responsive" src="{{ asset('templates/kkr021/images/blog/blog1.jpg')}}" alt="" /> </div>
                        ...
                        <div class="masonry-item">
                           <div class="post post-over">
                              <div class="post-image clearfix"> <i class="lnr lnr-camera"></i> <img class="img-responsive" src="{{ asset('templates/kkr021/images/blog/blog2.jpg')}}" alt="" /> </div>
                              <div class="post-details">
                        ...
                        <div class="masonry-item">
                           <div class="post post-over">
                              <div class="post-image clearfix"> <i class="lnr lnr-camera"></i> <img class="img-responsive" src="{{ asset('templates/kkr021/images/blog/blog3.jpg')}}" alt="" /> </div>
                              <div class="post-details">
                        ...
                        <div class="masonry-item">
                           <div class="post post-over">
                              <div class="post-image clearfix"> <i class="lnr lnr-camera"></i> <img class="img-responsive" src="{{ asset('templates/kkr021/images/blog/blog4.jpg')}}" alt="" /> </div>
                              <div class="post-details">
                                 <span class="categery text-uppercase">Lifestyle</span>
                                 <div class="post-date">27<span>NAV 2017</span></div>
                                 <div class="post-title">
                        ...
                        <div class="masonry-item">
                           <div class="post post-over">
                              <div class="post-image clearfix"> <i class="lnr lnr-camera"></i> <img class="img-responsive" src="{{ asset('templates/kkr021/images/blog/blog5.jpg')}}" alt="" /> </div>
                              <div class="post-details">
                                 <span class="categery text-uppercase">Businesses</span>
                        ...
                        <div class="masonry-item">
                           <div class="post post-over">
                              <div class="post-image clearfix"> <i class="lnr lnr-camera"></i> <img class="img-responsive" src="{{ asset('templates/kkr021/images/blog/blog6.jpg')}}" alt="" /> </div>
                              <div class="post-details">
                        ...
                        <div class="masonry-item">
                           <div class="post post-over">
                              <div class="post-image clearfix"> <i class="lnr lnr-camera"></i> <img class="img-responsive" src="{{ asset('templates/kkr021/images/blog/blog7.jpg')}}" alt="" /> </div>
                              <div class="post-details">
                                 <span class="categery text-uppercase">Lifestyle</span>
                                 <div class="post-date">27<span>NAV 2017</span></div>
                                 <div class="post-title">
                                    <h3 class="title"><a href="#">Learn the rules first</a></h3>
                                 </div>
                                 <div class="post-content">
                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry</p>
                                 </div>
