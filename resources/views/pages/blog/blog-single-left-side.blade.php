                     ...
                     <div class="row">
                        ...
                        <div class="col-sm-6 text-right">
                           <ul class="page-breadcrumb">
                              ...
                              <li><span class="theme-text">Left Sidebar</span> </li>
                           </ul>
                        </div>
                     </div>
                  </div>
                     ...
                     <div class="post">
                        ...
                        <div class="post-details">
                           <div class="post-title">
                              <h3 class="title"><a href="#"><i class="lnr lnr-camera"></i> Taken right to the edge</a></h3>
                           </div>
                           <div class="post-meta"> <a href="#"><i class="lnr lnr-clock"></i> 01 APR 2017</a> <a href="#"><i class="fa fa-user"></i> Admin</a> <a href="#"><i class="fa fa-heart-o" aria-hidden="true"></i>98 Like</a> <a href="#"><i class="fa fa-comments-o"></i>Comments</a> </div>
