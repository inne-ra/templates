...
<html lang="en" class="ie9">
   ...
   <html lang="en">
      ...
      <body>
            ...
            <div class="container-fluid">
               <div class="row intro-title">
                  <div class="col-sm-12 text-left">
                     <h1 class="title text-white">Blog Full Width</h1>
                  </div>
                  <div class="col-sm-12">
                     <div class="row">
                        ...
                        <div class="col-sm-6 text-right">
                           <ul class="page-breadcrumb">
                              ...
                              <li><span class="theme-text">Blog Full Width</span> </li>
                           </ul>
                        </div>
                     </div>
                  </div>
         ...
         <section class="masonry-main blog-post pt-3 pb-3">
            <div class="container-fluid">
               <div class="row">
                  <div class="col-md-12">
                     <div class="masonry blog-masonry column-4">
