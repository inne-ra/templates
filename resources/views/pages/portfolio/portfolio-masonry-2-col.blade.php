            ...
            <div class="container">
               <div class="row intro-title">
                  <div class="col-sm-12 text-left">
                     <h1 class="title text-white">Our Projects</h1>
                  </div>
                  <div class="col-sm-12">
                     <div class="row">
                        ...
                        <div class="col-sm-6 text-right">
                           <ul class="page-breadcrumb">
                              ...
                              <li><span class="theme-text">2 Columns</span> </li>
                           </ul>
                        </div>
                     </div>
                  </div>
               ...
               <div class="row">
                  <div class="col-xs-12 p-0">
                     <div class="b-isotope popup-gallery b-isotope-3">
                        <ul class="mb-4 b-isotope-filter clearfix list-inline text-center">
                        ...
                        <ul class="b-isotope-grid grid list-unstyled columns2">
                           ...
                           <li class="grid-item app">
                              <div class="isotope-img portfolio-item">
                                 <div class="item-img">
                                    <div class="overlay"> <a class="link-icon popup-img" title="Project" href="{{ asset('templates/kkr021/images/portfolio/app/img4.jpg')}}"><i class="lnr lnr-picture"></i></a> <a class="link-icon" href="#"><i class="lnr lnr-link"></i></a> </div>
                                    <img src="{{ asset('templates/kkr021/images/portfolio/app/img4.jpg')}}" alt="App" /> 
                                 </div>
                                 <div class="image-info">
                                    <h3 class="name"><a href="#">Lorem ipsum dolor sit amet</a></h3>
                                    <a class="link-icon" href="#">Sed do eiusmod tempor</a> 
                           ...
                           <li class="grid-item branding">
                              <div class="isotope-img portfolio-item">
                                 <div class="item-img">
                                    <div class="overlay"> <a class="link-icon popup-img" title="Project" href="{{ asset('templates/kkr021/images/portfolio/branding/img2.jpg')}}"><i class="lnr lnr-picture"></i></a> <a class="link-icon" href="#"><i class="lnr lnr-link"></i></a> </div>
                                    <img src="{{ asset('templates/kkr021/images/portfolio/branding/img2.jpg')}}" alt="Branding" /> 
                                 </div>
                                 <div class="image-info">
                                    <h3 class="name"><a href="#">Lorem ipsum dolor sit amet</a></h3>
                                    <a class="link-icon" href="#">Sed do eiusmod tempor</a> 
