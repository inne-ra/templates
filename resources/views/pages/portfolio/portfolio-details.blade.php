      ...
      <html class="no-js lt-ie9" lang="">
            ...
            <div class="container">
               <div class="row intro-title">
                  <div class="col-sm-12 text-left">
                     <h1 class="title text-white">Portfolio Details</h1>
                  </div>
                  <div class="col-sm-12">
                     <div class="row">
                        ...
                        <div class="col-sm-6 text-right">
                           <ul class="page-breadcrumb">
                              <li><a href="index-default">Portfolio</a></li>
                              <li><span class="theme-text">Single Post</span> </li>
                           </ul>
                        </div>
                     </div>
                  </div>
         ...
         <section class="section-sm">
            <div class="container">
               <div class="row">
                  <div class="col-sm-8">
                     <div class="owl-carousel" data-items="2" data-md-items="1" data-sm-items="1" data-xs-items="1" data-nav-arrow="true" data-space="0">
                        <div class="item"><img class="img-responsive" src="{{ asset('templates/kkr021/images/portfolio/branding/img1.jpg')}}" alt="img" /></div>
                        <div class="item"><img class="img-responsive" src="{{ asset('templates/kkr021/images/portfolio/branding/img3.jpg')}}" alt="img" /></div>
                        <div class="item"><img class="img-responsive" src="{{ asset('templates/kkr021/images/portfolio/branding/img4.jpg')}}" alt="img" /></div>
                        <div class="item"><img class="img-responsive" src="{{ asset('templates/kkr021/images/portfolio/app/img1.jpg')}}" alt="img" /></div>
                        <div class="item"><img class="img-responsive" src="{{ asset('templates/kkr021/images/portfolio/app/img2.jpg')}}" alt="img" /></div>
                     </div>
                     <div class="mt-3">
                     ...
                     <div class="row share-block">
                        <div class="col-md-6 sm-mb-2"><h6 class="mt-1 solid-weight text-dark btn-block">Did You Like This Post?  Share it :</h6></div>
                        <div class="col-md-6">
                           <div class="social-icons color-hover pull-right sm-pull-left">
                  ...
                  <div class="col-sm-4">
                     <div class="project-info mb-4">
                        <h4 class="mb-2">Project Information</h4>
                        <ul class="list-unstyled">
                           <li><label>Customer</label> <span>Torrefacto Coffee</span></li>
                           <li><label>Date</label> <span>1 May 2017</span></li>
                           <li><label>Category</label> <span>Design, App</span></li>
                        </ul>
                     </div>
                     <div class="widget-tweets">
                        <h4 class="mb-2">Our Tweets</h4>
                        <div class="tweets-carousel theme-bg">
        ...
        <!-- End Description -->
        <!-- Related Work -->
         <section class="section-sm grey-bg">
            <div class="container">
               <div class="row">
                  <div class="col-sm-12"><h4 class="mb-2">Related Work</h4></div>
                  <div class="col-sm-12">
                     <div class="owl-carousel" data-items="3" data-md-items="3" data-sm-items="2" data-xs-items="2" data-space="15">
                        <div class="item">
                           <div class="portfolio-item effect-3">
                              <div class="item-img"><img class="img-responsive" src="{{ asset('templates/kkr021/images/portfolio/photo/img1.jpg')}}" alt="foto" /></div>
                              <div class="image-info theme-bg">
                        ...
                        <div class="item">
                           <div class="portfolio-item effect-3">
                              <div class="item-img"><img class="img-responsive" src="{{ asset('templates/kkr021/images/portfolio/photo/img2.jpg')}}" alt="foto" /></div>
                              <div class="image-info theme-bg">
                                 <h3 class="name"><a href="#">Lorem ipsum dolor sit amet</a></h3>
                                 <a class="link-icon" href="#">Sed do eiusmod tempor</a>
                              </div>
                        ...
                        <div class="item">
                           <div class="portfolio-item effect-3">
                              <div class="item-img"><img class="img-responsive" src="{{ asset('templates/kkr021/images/portfolio/photo/img3.jpg')}}" alt="foto" /></div>
                              <div class="image-info theme-bg">
                                 <h3 class="name"><a href="#">Lorem ipsum dolor sit amet</a></h3>
                                 <a class="link-icon" href="#">Sed do eiusmod tempor</a>
                              </div>
                        ...
                        <div class="item">
                           <div class="portfolio-item effect-3">
                              <div class="item-img"><img class="img-responsive" src="{{ asset('templates/kkr021/images/portfolio/design/img3.jpg')}}" alt="foto" /></div>
                              <div class="image-info theme-bg">
                                 <h3 class="name"><a href="#">Lorem ipsum dolor sit amet</a></h3>
                                 <a class="link-icon" href="#">Sed do eiusmod tempor</a>
                              </div>
         ...
         <footer class="footer-dark">
            <div class="footer-top">
               <div class="container">
                  <div class="row">
                     <div class="col-sm-3">
                        <h6 class="text-uppercase">ABOUT SALIENT</h6>
                        <ul class="list-unstyled address">
                           <li><i class="lnr lnr-map-marker"></i><span>Jakarta, Indonesia</span></li>
                           <li><i class="lnr lnr-envelope"></i><span>support@remotehub.id</span></li>
                           <li><i class="icon-phone"></i><span>(+91) 123-456-7890</span></li>
                     ...
                     <div class="col-sm-3">
                        ...
                        <ul class="list-unstyled recent-post">
                           <li><a href="#">Be My Guest<span>July 14,2014</span></a></li>
                           <li><a href="#">Ownage In The Mountains<span>February 14,2013</span></a></li>
                           <li><a href="#">The Field<span>March 23,2013</span></a></li>
                        </ul>
                     </div>
                  </div>
               </div>
