            ...
            <div class="container-fluid">
               ...
               <div class="row">
                  ...
                  <div class="col-xs-6 col-lg-3 mb-4">
                     <div class="portfolio-item effect-1">
                        <div class="item-img">
                           <img src="{{ asset('templates/kkr021/images/portfolio/app/img3.jpg')}}" alt="Photo" />
               ...
               <div class="row">
                  <div class="col-xs-6 col-lg-3 xs-mb-5">
                     <div class="portfolio-item effect-1">
                        <div class="item-img">
                           <img src="{{ asset('templates/kkr021/images/portfolio/branding/img3.jpg')}}" alt="Branding" />
