                  ...
                  <div class="col-md-6 col-sm-8">
                     <div class="py-7 pr-7 xs-pr-0">
                        <div class="heading-block">
                           <h2 class="text-uppercase solid-weight">How To Find Us</h2>
                           <span class="text-uppercase light-weight">We are located in New York</span>                         
                           <div class="divider"></div>
                        </div>
                        <ul class="icon-list2 lead">
                           <li><span class="lnr lnr-map-marker"></span><span>121 King Street, Melbourne, Victoria 3000,<br/> Australia</span></li>
                        ...
                        <h4 class="text-uppercase solid-weight mt-5">Contact Now</h4>
						...
						<form id="contactform" role="form" method="post" action="php/contact-form.php">
                           <div class="row">
                              ...
                              <div class="form-group col-md-12">
                                 <a id="submit-btn" href="javascript:void(0)" class="btn btn-default fill-dark btn-rounded">Submit <i class="fa fa-arrow" aria-hidden="true"></i></a>
                              </div>
                           </div>
                        </form>
