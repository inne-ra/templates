                  ...
                  <div class="col-md-6 col-sm-8 col-sm-offset-4 col-md-offset-6">
                     <div class="py-7 pl-7 xs-py-4 sm-py-5 sm-pl-7 xs-pl-0">
                        <div class="heading-block">
                           <h2 class="text-uppercase solid-weight">Get In Touch</h2>
                           <span class="text-uppercase light-weight">Our Offices</span>                           
                        ...
                        <div class="pos-r">
                           <div class="tab outline rounded clearfix">
                              ...
                              <ul class="nav nav-tabs" role="tablist">
                                 <li class="active"><a href="#tab12-1" data-toggle="tab" aria-expanded="false">Head Quarter</a></li>
                                 <li class=""><a href="#tab12-2" data-toggle="tab" aria-expanded="true">London</a></li>
                                 <li><a href="#tab12-3" data-toggle="tab">New York</a></li>
                              </ul>
                              <!-- Tab panes -->
                              <div class="tab-content">
                                 <div role="tabpanel" class="tab-pane active in fade" id="tab12-1">
                                    <p class="lead">If you are interested in working with us then please drop us a line, we would love to hear from you.</p>
                                    <h4 class="solid-weight text-uppercase">Head Quarter</h4>
                                    <ul class="icon-list2 lead">
                                       <li><span class="lnr lnr-map-marker"></span><span>121 King Street, Melbourne,<br/> Victoria 3000, Australia</span></li>
                                       <li><span class="lnr lnr-envelope"></span>support@yourname.com</li>
                                 ...
                                 <div role="tabpanel" class="tab-pane fade  " id="tab12-2">
                                    <p class="lead">If you are interested in working with us then please drop us a line, we would love to hear from you.</p>
                                    <h4 class="solid-weight text-uppercase">London</h4>
                                    <ul class="icon-list2 lead">
                                       <li><span class="lnr lnr-map-marker"></span><span>121 King Street, Melbourne,<br/> Victoria 3000, Australia</span></li>
                                       <li><span class="lnr lnr-envelope"></span>support@yourname.com</li>
                                       <li><span class="lnr lnr-phone-handset"></span>(415) 124-5678</li>
                                 ...
                                 <div role="tabpanel" class="tab-pane fade" id="tab12-3">
                                    <p class="lead">If you are interested in working with us then please drop us a line, we would love to hear from you.</p>
                                    <h4 class="solid-weight text-uppercase">New York</h4>
                                    <ul class="icon-list2 lead">
                                       <li><span class="lnr lnr-map-marker"></span><span>121 King Street, Melbourne,<br/> Victoria 3000, Australia</span></li>
                                       <li><span class="lnr lnr-envelope"></span>support@yourname.com</li>
                                       <li><span class="lnr lnr-phone-handset"></span>(415) 124-5678</li>
					 ...
					 <form id="contactform" role="form" method="post" action="php/contact-form.php">
                        <div class="row">
                           <div class="form-group col-md-6">
                              <input type="text" name="name" id="name" class="form-control border-bottom" placeholder="Name*" value="">
                           </div>
                           <div class="form-group col-md-6">
                              <input type="email" name="email" id="email" class="form-control border-bottom" placeholder="Email*" value="">
                           </div>
                           <div class="form-group col-md-12">
                              <input type="text" name="subject" id="subject" class="form-control border-bottom" placeholder="Subject*" value="">
                           </div>
                           <div class="form-group col-md-12">
                              <textarea name="message" class="form-control border-bottom" rows="3" placeholder="Message"></textarea>
                           </div>
                           <div class="form-group col-md-12 mb-0">
								<input type="hidden" name="action" value="sendEmail"/>
								<button id="submit-btn" name="submit" type="submit" value="Send" class="btn btn-default btn-radius fill-white"><span>Submit Now</span></button>

                           </div>
                        </div>
                     </form>
					 <div id="ajaxloader" style="display:none"><img class="center-block" src="templates/kkr021/images/loading.gif" alt=""></div> 
                  </div>
               </div>
            </div>
         </section>
