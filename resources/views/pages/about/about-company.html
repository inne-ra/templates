               ...
               <div class="row mb-3">
                  ...
                  <div class="col-sm-6 ">
                     <div class="video-info">
                        <img class="img-responsive center-block" src="templates/kkr021/images/corporate/image2.jpg" alt="">
                        <a class="popup-vimeo video-btn theme-bg" href="video/video.mp4"><i class="icon-control-play icons"></i></a>
                     </div>
                  </div>
               </div>
               <!-- Technology -->
                     ...
                     <div class="owl-carousel owl-theme light-arrow" data-items="3" data-md-items="3" data-sm-items="3" data-xs-items="2" data-nav-dots="false" data-nav-arrow="false" data-auto-play="true"  data-space="0">
                        <div class="item">
                           <div class="team">
                              <div class="member-image clearfix">
                                 ...
                                 <img class="img-responsive" src="templates/kkr021/images/team/member2.jpg" alt="" />
                              </div>
                              <div class="team-info">
                        ...
                        <div class="item">
                           <div class="team">
                              <div class="member-image clearfix">
                                 <a class="arrow-btn" href="#"><i class="lnr lnr-arrow-right"></i></a>
                                 <img class="img-responsive" src="templates/kkr021/images/team/member3.jpg" alt="" />
                              </div>
                              <div class="team-info">
                        ...
                        <div class="item">
                           <div class="team">
                              <div class="member-image clearfix">
                                 <a class="arrow-btn" href="#"><i class="lnr lnr-arrow-right"></i></a>
                                 <img class="img-responsive" src="templates/kkr021/images/team/member4.jpg" alt="" />
                              </div>
                              <div class="team-info">
