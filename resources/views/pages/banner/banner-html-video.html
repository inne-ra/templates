      ...
      <html class="no-js lt-ie9" lang="">
         ...
         <html class="no-js" lang="en">
            ...
            <body>
               ...
               <!-- End Navigation -->
         <!-- Banner -->
         <section class="full-height bg white-text header-slide single-image overlay jarallax" data-overlay-color="dark" data-overlay="8" data-bg-img="video/video.jpg')}}"  data-jarallax='{"type": "scroll-opacity"}' data-jarallax-video='mp4:video/video.mp4'>
            <div class="container">
               <div class="row">
                  <div class="col-md-8 col-md-offset-2 text-center">
                     <h1 class="title">HTML5 Video</h1>
