   ...
   <html class="no-js lt-ie9 lt-ie8" lang="">
      ...
      <html class="no-js lt-ie9" lang="">
         ...
         <section class="full-height fullscreen bg white-text header-slide">
            <div class="owl-carousel owl-theme light-arrow" data-items="1" data-md-items="1" data-sm-items="1" data-nav-dots="true" data-nav-arrow="true" data-auto-play="false"  data-space="0">
               <div class="item"  >
                  <div class="slide-img"><img src="{{ asset('templates/kkr021/images/banner.jpg')}}" alt=""></div>
                  <div class="container">
                     <div class="row">
                        <div class="col-md-8">
                           <h1 class="title">Owl Slider</h1>
