...
<html lang="en" class="ie9">
   ...
   <html lang="en">
      ...
      <head>
         ...
         <!-- Simpletextrotator -->
         <link rel="stylesheet" type="text/css" href="{{ asset('templates/kkr021/css/simpletextrotator.css')}}" />
         <!-- Responsive -->
         ...
         <link rel="shortcut icon" href="favicon.ico"/>
            ...
            <body>
               ...
               <!-- End Navigation -->
         <!-- Banner -->
         <section class="full-height bg white-text header-slide single-image overlay jarallax" data-overlay-color="dark" data-overlay="8" data-bg-img="{{ asset('templates/kkr021/images/banner.jpg')}}" data-jarallax='{"speed": 0.2}'>
            <div class="container">
               <div class="row">
                  <div class="col-md-8 col-md-offset-2 text-center">
                     <h1 class="title"><span class="textrotator">Smart. Simple. Responsive.,Flexible. Stunning.</span></h1>
                     <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                     <a href="#" class="btn btn-default btn-radius btn-outline white-border white-text fill-white">Read More</a>&nbsp;&nbsp;
                     <a href="#" class="btn btn-default btn-radius theme-bg white-text">Purchase Now <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                  </div>
               </div>
            </div>
         </section>
        ...
        <!-- End footer -->
         ...
         <!-- Bootsnavs -->
         <script src="{{ asset('templates/kkr021/js/jquery.simple-text-rotator.min.js')}}"></script>
         <!-- Bootsnavs -->
