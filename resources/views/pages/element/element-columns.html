            ...
            <div class="container">
               <div class="row intro-title">
                  <div class="col-sm-12 text-left">
                     <h1 class="title text-white">Column</h1>
                  </div>
                  <div class="col-sm-12">
                     <div class="row">
                        ...
                        <div class="col-sm-6 text-right">
                           <ul class="page-breadcrumb">
                              ...
                              <li><span class="theme-text">Column</span> </li>
                           </ul>
                        </div>
                     </div>
                  </div>
            ...
            <div class="container">
               <div class="row">
                  <div class="col-lg-12 col-md-12 text-center mb-30">
                     <div class="col-bg"> 12 Column </div>
                  </div>
                  <div class="col-lg-6 col-md-6 text-center mb-30">
                     <div class="col-bg"> 6 Column </div>
                  </div>
                  <div class="col-lg-6 col-md-6 text-center mb-30">
                     <div class="col-bg"> 6 Column </div>
                  </div>
                  <div class="col-lg-4 col-md-4 text-center mb-30">
                     <div class="col-bg"> 4 Column </div>
                  </div>
                  <div class="col-lg-8 col-md-8 text-center mb-30">
                     <div class="col-bg"> 8 Column </div>
                  </div>
                  <div class="col-lg-7 col-md-7 text-center mb-30">
                     <div class="col-bg"> 7 Column </div>
                  </div>
                  <div class="col-lg-5 col-md-5 text-center mb-30">
                     <div class="col-bg"> 5 Column </div>
                  </div>
                  <div class="col-lg-3 col-md-3 text-center mb-30">
                     <div class="col-bg"> 3 Column </div>
                  </div>
                  <div class="col-lg-9 col-md-9 text-center mb-30">
                     <div class="col-bg"> 9 Column </div>
                  </div>
                  <div class="col-lg-4 col-md-4 text-center mb-30">
                     <div class="col-bg"> 4 Column </div>
                  </div>
                  ...
                  <div class="col-lg-2 col-md-2 text-center mb-30">
                     <div class="col-bg"> 2 Column </div>
                  </div>
                  <div class="col-lg-2 col-md-2 text-center mb-30">
                     <div class="col-bg"> 2 Column </div>
                  </div>
