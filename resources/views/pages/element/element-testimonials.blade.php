            ...
            <div class="container">
               <div class="row intro-title">
                  <div class="col-sm-12 text-left">
                     <h1 class="title text-white">Testimonials</h1>
                  </div>
                  <div class="col-sm-12">
                     <div class="row">
                        ...
                        <div class="col-sm-6 text-right">
                           <ul class="page-breadcrumb">
                              ...
                              <li><span class="theme-text">Testimonials</span> </li>
                           </ul>
                        </div>
                     </div>
                  </div>
               ...
               <div class="row">
                  <div class="col-sm-12 col-md-10 col-lg-8 col-md-offset-1 col-lg-offset-2">
                     <div class="heading-block text-left">
                        <h4 class="text-uppercase ">Defult testimonials</h4>
                  ...
                  <div class="col-sm-12 col-md-10 col-lg-8 col-md-offset-1 col-lg-offset-2">
                     <div class="testimonials">
                        <div id="testimonials-slider" class="carousel slide" data-ride="carousel">
                           ...
                           <!-- Controls -->
                           <a class="left carousel-control" href="#testimonials-slider" role="button" data-slide="prev"><i class="lnr lnr-arrow-left"></i></a>
                           <a class="right carousel-control" href="#testimonials-slider" role="button" data-slide="next"><i class="lnr lnr-arrow-right"></i></a>
                        </div>
                     </div>
                  </div>
               </div>
         ...
         <section class="section-pt">
            <div class="container">
               <div class="row">
                  <div class="col-sm-12 col-md-10 col-lg-8 col-md-offset-1 col-lg-offset-2">
                     <div class="heading-block text-left">
                        <h4 class="text-uppercase ">Testimonials with image</h4>
                        <div class="divider"></div>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="col-sm-12 col-md-10 col-lg-8 col-md-offset-1 col-lg-offset-2">
                     <div class="testimonials">
                        <div id="testimonials-slider3" class="carousel slide" data-ride="carousel">
                           ...
                           <!-- Controls -->
                           <a class="left carousel-control" href="#testimonials-slider3" role="button" data-slide="prev"><i class="lnr lnr-arrow-left"></i></a>
                           <a class="right carousel-control" href="#testimonials-slider3" role="button" data-slide="next"><i class="lnr lnr-arrow-right"></i></a>
                        </div>
                     </div>
                  </div>
               </div>
