            ...
            <div class="container">
               <div class="row intro-title">
                  <div class="col-sm-12 text-left">
                     <h1 class="title text-white">Feature Box</h1>
                  </div>
                  <div class="col-sm-12">
                     <div class="row">
               ...
               <div class="row">
                  <div class="col-sm-12">
                     <div class="heading-block text-center">
                        <h4 class="text-uppercase ">Feature box defult</h4>
         ...
         <section class="theme-bg">
            <div class="container">
               <div class="row">
                  <div class="col-sm-12">
                     <div class="heading-block text-center">
                        <h4 class="text-uppercase ">Feature box Icon Position right</h4>
                        <div class="divider"></div>
                     </div>
                  </div>
               </div>
         ...
         <section>
            <div class="container">
               <div class="row">
                  <div class="col-sm-12">
                     <div class="heading-block text-center">
                        <h4 class="text-uppercase ">Feature box Icon Position left</h4>
                        <div class="divider"></div>
                     </div>
                  </div>
               </div>
         ...
         <section class="dark-bg">
            <div class="container">
               <div class="row">
                  <div class="col-sm-12">
                     <div class="heading-block text-center">
                        <h4 class="text-uppercase ">Fature box large</h4>
                        <div class="divider"></div>
                     </div>
                  </div>
               </div>
         ...
         <section>
            <div class="container">
               <div class="row">
                  <div class="col-sm-12">
                     <div class="heading-block text-center">
                        <h4 class="text-uppercase ">Fature box Medium</h4>
                        <div class="divider"></div>
                     </div>
                  </div>
               </div>
