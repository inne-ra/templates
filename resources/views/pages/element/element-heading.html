            ...
            <div class="container">
               <div class="row intro-title">
                  <div class="col-sm-12 text-left">
                     <h1 class="title text-white">Headings</h1>
                  </div>
                  <div class="col-sm-12">
                     <div class="row">
                        ...
                        <div class="col-sm-6 text-right">
                           <ul class="page-breadcrumb">
                              ...
                              <li><span class="theme-text">Headings</span> </li>
                           </ul>
                        </div>
                     </div>
                  </div>
               ...
               <div class="row">
                  ...
                  <div class="col-md-4">
                     <div class="heading-block text-left">
                        <h2 class="text-uppercase text-theme">Heading module</h2>
                        <span class="text-uppercase solid-weight">Subtitle of  Heading</span>
                  ...
                  <div class="col-md-4">
                     <div class="heading-block text-center">
                        <h2 class="text-uppercase ">Heading module</h2>
                        <span class="text-uppercase solid-weight">Subtitle of  Heading</span>
                        <div class="divider"></div>
                     </div>
                     <p class="text-center">There are many variations of passages of Lorem Ipsum available,but the majority have suffered alteration in some form.</p>
                  </div>
                  <!-- End Heading styles2 -->
                  <!-- Heading styles3 -->
                  <div class="col-md-4">
                     ...
                     <p class="text-right">There are many variations of passages of Lorem Ipsum available,but the majority have suffered alteration in some form.</p>
                  </div>
                  <!-- End Heading styles3 -->          
               </div>
            </div>
         ...
         <section class="section-pt">
            <div class="container">
               <div class="row">
                  ...
                  <div class="col-md-4">
                     <div class="heading-block text-left">
                        <span class="text-uppercase heading-sub-title solid-weight">Subtitle of  Heading</span>
                        <h2 class="light-weight">Heading module</h2>
                     </div>
                     <p>There are many variations of passages of Lorem Ipsum available,but the majority have suffered alteration in some form.</p>
                  </div>
                  <!-- End Heading styles4 -->
                  ...
                  <div class="col-md-4">
                     <div class="heading-block text-center">
                        <span class="text-uppercase solid-weight">Subtitle of  Heading</span>
                        <h2 class="light-weight text-theme">Heading module</h2>
                     </div>
                     <p class="text-center">There are many variations of passages of Lorem Ipsum available,but the majority have suffered alteration in some form.</p>
                  </div>
                  <!-- End Heading styles5 -->
