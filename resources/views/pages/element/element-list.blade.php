            ...
            <div class="container">
               <div class="row intro-title">
                  <div class="col-sm-12 text-left">
                     <h1 class="title text-white">Lists</h1>
                  </div>
                  <div class="col-sm-12">
                     <div class="row">
                        ...
                        <div class="col-sm-6 text-right">
                           <ul class="page-breadcrumb">
                              ...
                              <li><span class="theme-text">Lists</span> </li>
                           </ul>
                        </div>
                     </div>
                  </div>
               ...
               <div class="row">
                  <div class="col-sm-12">
                     <div class="heading-block text-center">
                        <h4 class="text-uppercase text-theme">Simple list</h4>
         ...
         <section class="section-pt">
            <div class="container">
               <div class="row">
                  <div class="col-sm-12">
                     <div class="heading-block text-center">
                        <h4 class="text-uppercase text-theme">List Icon With Class</h4>
                        <div class="divider"></div>
                     </div>
                  </div>
               </div>
               <div class="row">
                  ...
                  <div class="col-sm-4">
                     <ul class="line-icon arrow-right">
                        <li>Contrary to popular belief</li>
                        <li>In a free hour</li>
                        <li>Written by Cicero in 45 BC</li>
                        <li>De Finibus Bonorum et Malorum</li>
         ...
         <section class="section-pt">
            <div class="container">
               <div class="row">
                  <div class="col-sm-12">
                     <div class="heading-block text-center">
                        <h4 class="text-uppercase text-theme">Font Awesome List Icon</h4>
                        <div class="divider"></div>
                     </div>
                  </div>
               </div>
               <div class="row">
                  <div class="col-sm-4 xs-mb-4">
                     <ul class="line-icon manual-icon">
                        <li><i class="fa fa-dot-circle-o" aria-hidden="true"></i> Contrary to popular belief</li>
                        <li><i class="fa fa-dot-circle-o" aria-hidden="true"></i> In a free hour</li>
                        <li><i class="fa fa-dot-circle-o" aria-hidden="true"></i> Written by Cicero in 45 BC</li>
                        <li><i class="fa fa-dot-circle-o" aria-hidden="true"></i> De Finibus Bonorum et Malorum</li>
                        <li><i class="fa fa-dot-circle-o" aria-hidden="true"></i> The standard Lorem Ipsum passage</li>
                     </ul>
                  </div>
                  <div class="col-sm-4 xs-mb-4">
                     <ul class="line-icon manual-icon">
                        <li><i class="fa fa-plus-square" aria-hidden="true"></i> Contrary to popular belief</li>
                        <li><i class="fa fa-plus-square" aria-hidden="true"></i> In a free hour</li>
                        <li><i class="fa fa-plus-square" aria-hidden="true"></i> Written by Cicero in 45 BC</li>
                        <li><i class="fa fa-plus-square" aria-hidden="true"></i> De Finibus Bonorum et Malorum</li>
                        <li><i class="fa fa-plus-square" aria-hidden="true"></i> The standard Lorem Ipsum passage</li>
                     </ul>
                  </div>
                  <div class="col-sm-4">
                     <ul class="line-icon manual-icon">
                        <li><i class="fa fa-chevron-circle-right" aria-hidden="true"></i> Contrary to popular belief</li>
                        <li><i class="fa fa-chevron-circle-right" aria-hidden="true"></i> In a free hour</li>
                        <li><i class="fa fa-chevron-circle-right" aria-hidden="true"></i> Written by Cicero in 45 BC</li>
                        <li><i class="fa fa-chevron-circle-right" aria-hidden="true"></i> De Finibus Bonorum et Malorum</li>
                        <li><i class="fa fa-chevron-circle-right" aria-hidden="true"></i> The standard Lorem Ipsum passage</li>
                     </ul>
                  </div>
               </div>
            </div>
