      ...
      <html class="no-js lt-ie9" lang="">
            ...
            <div class="container">
               <div class="row intro-title">
                  <div class="col-sm-12 text-left">
                     <h1 class="title text-white">Social Icons</h1>
                  </div>
                  <div class="col-sm-12">
                     <div class="row">
                        ...
                        <div class="col-sm-6 text-right">
                           <ul class="page-breadcrumb">
                              ...
                              <li><span class="theme-text">Social Icons</span> </li>
                           </ul>
                        </div>
                     </div>
                  </div>
         ...
         <section>
            <div class="container">
               <div class="row">
                  ...
                  <div class="col-sm-6">
                     <div class="social-icons border color-hover">
                        <ul class="clearfix">
                           <li class="social-rss"><a href="#"><i class="fa fa-rss"></i></a></li>
                           <li class="social-facebook"><a href="#"><i class="fa fa-facebook"></i></a></li>
                           <li class="social-twitter"><a href="#"><i class="fa fa-twitter"></i></a></li>
         ...
         <section class="pt-0">
            <div class="container">
               <div class="row">
                  <div class="col-sm-6">
                     <div class="social-icons border rounded color-hover">
                        <ul class="clearfix">
                           <li class="social-rss"><a href="#"><i class="fa fa-rss"></i></a></li>
                           <li class="social-facebook"><a href="#"><i class="fa fa-facebook"></i></a></li>
                           <li class="social-twitter"><a href="#"><i class="fa fa-twitter"></i></a></li>
         ...
         <section class="pt-0">
            <div class="container">
               <div class="row">
                  <div class="col-sm-6">
                     <div class="social-icons animated border effect-1">
                        <ul class="clearfix">
                           <li class="social-rss"><a href="#"><i class="fa fa-rss"></i></a></li>
                           <li class="social-facebook"><a href="#"><i class="fa fa-facebook"></i></a></li>
                           <li class="social-twitter"><a href="#"><i class="fa fa-twitter"></i></a></li>
                  ...
                  <div class="col-sm-6">
                     <div class="social-icons border effect-2">
                        <ul class="clearfix">
                           <li class="social-rss"><a href="#"><i class="fa fa-rss"></i></a></li>
                           <li class="social-facebook"><a href="#"><i class="fa fa-facebook"></i></a></li>
                           <li class="social-twitter"><a href="#"><i class="fa fa-twitter"></i></a></li>
            ...
            <div class="container">
               <div class="row">
                  <div class="col-sm-12 text-center">
                     <div class="social-icons large color-hover">
                        <ul class="clearfix">
                        <li class="social-rss"><a href="#"><i class="fa fa-rss"></i></a></li>
                        <li class="social-facebook"><a href="#"><i class="fa fa-facebook"></i></a></li>
                        <li class="social-twitter"><a href="#"><i class="fa fa-twitter"></i></a></li>
                  ...
                  <div class="col-sm-12 text-center">
                     <div class="social-icons medium color-hover">
                        <ul class="clearfix">
                        <li class="social-rss"><a href="#"><i class="fa fa-rss"></i></a></li>
                        <li class="social-facebook"><a href="#"><i class="fa fa-facebook"></i></a></li>
                        <li class="social-twitter"><a href="#"><i class="fa fa-twitter"></i></a></li>
