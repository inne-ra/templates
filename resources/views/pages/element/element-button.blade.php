...
<html class="no-js lt-ie9 lt-ie8 lt-ie7" lang="">
   ...
   <html class="no-js lt-ie9 lt-ie8" lang="">
      ...
      <html class="no-js lt-ie9" lang="">
            ...
            <div class="container">
               <div class="row intro-title">
                  <div class="col-sm-12 text-left">
                     <h1 class="title text-white">Buttons</h1>
                  </div>
                  <div class="col-sm-12">
                     <div class="row">
                        ...
                        <div class="col-sm-6 text-right">
                           <ul class="page-breadcrumb">
                              ...
                              <li><span class="theme-text">Buttons</span> </li>
                           </ul>
                        </div>
                     </div>
                  </div>
         ...
         <!-- Button Default -->
         <section class="button-block sm-pb-4 xs-pb-1">
            <div class="container">
            <div class="row">
               <div class="col-sm-12">
                  <div class="heading-block text-left">
                     <h4 class="text-uppercase ">Button Default</h4>
            ...
            <div class="row">
               <div class="col-sm-12 text-left">
                  <a href="#" class="btn btn-default animated btn-radius">Button Radius <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                  <a href="#" class="btn btn-default animated icon-left btn-radius"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i> Button Outline</a>
                  <a href="#" class="btn btn-default btn-radius fill-dark">Button Radius <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                  <a href="#" class="btn btn-default btn-radius fill-white">Button Radius <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                  <a href="#" class="btn btn-default btn-radius hover-effect1">Button Outline <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                  <a href="#" class="btn btn-default hover-effect2 icon-left"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i> Button Radius</a>
                  <a href="#" class="btn btn-default hover-effect3">Button Radius <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                  <a href="#" class="btn btn-link animated icon-left">Button Link <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                  <a href="#" class="btn btn-link animated">Button Link <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
               </div>
            </div>
         </div>
         </section>
         <!-- End Button Default -->
         <!-- Button Outline -->
         <section class="section-pt button-block">
            <div class="container">
               <div class="row">
                  <div class="col-sm-12">
                     <div class="heading-block text-left">
                        <h4 class="text-uppercase ">Button Outline</h4>
                        <div class="divider"></div>
                     </div>
                  </div>
               </div>
               <div class="row">
                  <div class="col-sm-12 text-left">
                     <a href="#" class="btn btn-default animated btn-outline btn-radius">Button Radius <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                     <a href="#" class="btn btn-default animated btn-outline icon-left btn-radius"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i> Button Outline</a>
                     <a href="#" class="btn btn-default btn-radius btn-outline fill-theme">Button Radius <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                     <a href="#" class="btn btn-default btn-radius btn-outline fill-dark">Button Radius <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                     <a href="#" class="btn btn-default btn-radius btn-outline fill-white">Button Radius <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                     <a href="#" class="btn btn-default btn-radius btn-outline hover-effect1">Button Outline <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                     <a href="#" class="btn btn-default btn-outline hover-effect2">Button Radius <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                     <a href="#" class="btn btn-default btn-outline hover-effect3">Button Radius <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                     <a href="#" class="btn btn-link animated icon-left">Button Link <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                     <a href="#" class="btn btn-link animated">Button Link <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                  </div>
               </div>
         ...
         <section class="section-pt button-block">
            <div class="container">
               <div class="row">
                  <div class="col-sm-12">
                     <div class="heading-block text-left">
                        <h4 class="text-uppercase ">Button Outline Dark</h4>
                        <div class="divider"></div>
                     </div>
                  </div>
               </div>
               <div class="row">
                  <div class="col-sm-12 text-left">
                     <a href="#" class="btn btn-default animated btn-outline dark-border btn-radius">Button Radius <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                     <a href="#" class="btn btn-default animated btn-outline dark-border icon-left btn-radius"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i> Button Outline</a>
                     <a href="#" class="btn btn-default btn-radius btn-outline dark-border fill-theme">Button Radius <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                     <a href="#" class="btn btn-default btn-radius btn-outline dark-border fill-dark">Button Radius <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                     <a href="#" class="btn btn-default btn-radius btn-outline dark-border fill-white">Button Radius <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                     <a href="#" class="btn btn-default btn-radius btn-outline dark-border hover-effect1">Button Outline <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                     <a href="#" class="btn btn-default btn-outline dark-border hover-effect2">Button Radius <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                     <a href="#" class="btn btn-default btn-outline dark-border hover-effect3">Button Radius <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                     <a href="#" class="btn btn-link animated dark-text icon-left">Button Link <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                     <a href="#" class="btn btn-link animated dark-text">Button Link <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                  </div>
               </div>
            </div>
         </section>
         <!-- End Button Outline Dark -->
         <!-- Button Transparent Background -->
         <section class="dark-bg button-block">
            <div class="container">
               <div class="row">
                  <div class="col-sm-12">
                     <div class="heading-block text-left">
                        <h4 class="text-uppercase ">Button Transparent Background</h4>
                        <div class="divider"></div>
                     </div>
                  </div>
               </div>
               <div class="row">
                  <div class="col-sm-12 text-left">
                     <a href="#" class="btn btn-default animated btn-outline white-border white-text btn-radius">Button Radius <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                     <a href="#" class="btn btn-default animated btn-outline white-border white-text icon-left btn-radius"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i> Button Outline</a>
                     <a href="#" class="btn btn-default btn-radius btn-outline white-border white-text fill-theme">Button Radius <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                     <a href="#" class="btn btn-default btn-radius btn-outline white-border white-text fill-white">Button Radius <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                     <a href="#" class="btn btn-default btn-radius btn-outline white-border white-text hover-effect1">Button Outline <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                     <a href="#" class="btn btn-default btn-outline white-border white-text hover-effect2">Button Radius <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                     <a href="#" class="btn btn-default btn-outline white-border white-text hover-effect3">Button Radius <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                     <a href="#" class="btn btn-link animated white-text icon-left">Button Link <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                     <a href="#" class="btn btn-link animated white-text">Button Link <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                  </div>
               </div>
            </div>
         </section>
         <!-- End Button Transparent Background -->
         ...
         <section class="button-block">
            <div class="container">
               <div class="row">
                  <div class="col-sm-12">
                     <div class="heading-block text-left">
                        <h4 class="text-uppercase ">Button Dark Background</h4>
                        <div class="divider"></div>
                     </div>
                  </div>
               </div>
               <div class="row">
                  <div class="col-sm-12 text-left">
                     <a href="#" class="btn btn-default dark-bg animated btn-radius">Button Radius <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                     <a href="#" class="btn btn-default dark-bg animated icon-left btn-radius"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i> Button Outline</a>
                     <a href="#" class="btn btn-default dark-bg btn-radius fill-theme">Button Radius <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                     <a href="#" class="btn btn-default dark-bg btn-radius fill-white">Button Radius <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                     <a href="#" class="btn btn-default dark-bg btn-radius hover-effect1">Button Outline <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                     <a href="#" class="btn btn-default dark-bg hover-effect2">Button Radius <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                     <a href="#" class="btn btn-default dark-bg hover-effect3">Button Radius <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                     <a href="#" class="btn btn-link animated dark-text icon-left">Button Link <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                     <a href="#" class="btn btn-link animated dark-text">Button Link <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                  </div>
               </div>
         ...
         <section class="section-pt button-block">
            <div class="container">
               <div class="row">
                  <div class="col-sm-12">
                     <div class="heading-block text-left">
                        <h4 class="text-uppercase ">Button Different Size</h4>
                        <div class="divider"></div>
                     </div>
                  </div>
               </div>
               <div class="row">
                  <div class="col-sm-12 text-left">
                     <a href="#" class="btn btn-lg btn-default animated">Button <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                     <a href="#" class="btn btn-lg btn-default animated btn-rounded">Button Rounded <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                     <a href="#" class="btn btn-lg btn-default animated btn-radius">Button Radius <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                     <a href="#" class="btn btn-lg btn-default animated btn-radius btn-outline">Button Outline <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                     <a href="#" class="btn btn-lg btn-link">Button Link</a>
                  </div>
                  <div class="col-sm-12 text-left">
                     <a href="#" class="btn btn-default animated">Button <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                     <a href="#" class="btn btn-default animated btn-rounded">Button Rounded <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                     <a href="#" class="btn btn-default animated btn-radius">Button Radius <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                     <a href="#" class="btn btn-default animated btn-radius btn-outline">Button Outline <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                     <a href="#" class="btn btn-link">Button Link</a>
                  </div>
                  <div class="col-sm-12 text-left">
                     <a href="#" class="btn btn-sm btn-default animated">Button <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                     <a href="#" class="btn btn-sm btn-default animated btn-rounded">Button Rounded <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                     <a href="#" class="btn btn-sm btn-default animated btn-radius">Button Radius <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                     <a href="#" class="btn btn-sm btn-default animated btn-radius btn-outline">Button Outline <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                     <a href="#" class="btn btn-sm btn-link">Button Link</a>
                  </div>
                  <div class="col-sm-12 text-left">
                     <a href="#" class="btn btn-xs btn-default animated">Button <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                     <a href="#" class="btn btn-xs btn-default animated btn-rounded">Button Rounded <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                     <a href="#" class="btn btn-xs btn-default animated btn-radius">Button Radius <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                     <a href="#" class="btn btn-xs btn-default animated btn-radius btn-outline">Button Outline <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                     <a href="#" class="btn btn-xs btn-link">Button Link</a>
                  </div>
               </div>
            </div>
         </section>
         <!-- End Button Different Size -->
         <!-- Footer -->
