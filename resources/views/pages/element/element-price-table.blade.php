            ...
            <div class="container">
               <div class="row intro-title">
                  <div class="col-sm-12 text-left">
                     <h1 class="title text-white">Pricing Table</h1>
                  </div>
                  <div class="col-sm-12">
                     <div class="row">
                        ...
                        <div class="col-sm-6 text-right">
                           <ul class="page-breadcrumb">
                              ...
                              <li><span class="theme-text">Pricing Table</span> </li>
                           </ul>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-sm-4 mb-4">
                     <div class="pricing-table">
                        ...
                        <div class="pricing-content">
                           ...
                           <a href="#" class="btn btn-default animated btn-radius">Add to Cart<i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                        </div>
                     </div>
                  </div>
                  <div class="col-sm-4 mb-4">
