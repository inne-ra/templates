      ...
      <html class="no-js lt-ie9" lang="">
            ...
            <div class="container">
               <div class="row intro-title">
                  <div class="col-sm-12 text-left">
                     <h1 class="title text-white">Form</h1>
                  </div>
                  <div class="col-sm-12">
                     <div class="row">
                        ...
                        <div class="col-sm-6 text-right">
                           <ul class="page-breadcrumb">
                              ...
                              <li><span class="theme-text">Form</span> </li>
                           </ul>
                        </div>
                     </div>
                  </div>
         ...
         <section>
            <div class="container">
               <div class="row">
                  <!-- form style defult -->
                  <div class=" col-sm-6 xs-mb-5">
                     <div class="row">
                        <div class="col-sm-12">
                           <div class="heading-block text-left">
                              <h4 class="text-uppercase ">Basic Forms</h4>
                     ...
                     <form>
                        <div class="row">
                           ...
                           <div class="form-group col-md-12">
                              <input class="btn btn-default btn-radius fill-dark" type="submit" value="Send Message">
                           </div>
                        </div>
                     </form>
                     </div>
                  <!-- form style defult -->
                  <!-- End form style border -->
                  <div class=" col-sm-6">
                     <div class="row">
                        <div class="col-sm-12">
                           <div class="heading-block text-left">
                              <h4 class="text-uppercase ">Style 2 Forms</h4>
                              <div class="divider"></div>
                           </div>
                        </div>
                     </div>
                     <form>
                        <div class="row">
                           <div class="form-group col-md-6">
                              <input type="text" class="form-control border-bottom" placeholder="Name">
                           </div>
                           <div class="form-group col-md-6">
                              <input type="email" class="form-control border-bottom" placeholder="Email">
                           </div>
                           <div class="form-group col-md-12">
                              <input type="text" class="form-control border-bottom" placeholder="Subject">
                           </div>
                           <div class="form-group col-md-12">
                              <textarea  class="form-control border-bottom" rows="3" placeholder="Meassage"></textarea>
                           </div>
                           <div class="form-group col-md-12">
                              <input class="btn btn-default btn-radius fill-dark" type="submit" value="Send Message">
                           </div>
               ...
               <div class="row">
                  ...
                  <div class=" col-sm-6 xs-mb-5">
                     <div class="row">
                        <div class="col-sm-12">
                           <div class="heading-block text-left">
                              <h4 class="text-uppercase ">Style 3 Forms</h4>
                              <div class="divider"></div>
                           </div>
                        </div>
                     </div>
                     <form>
                        <div class="row">
                           <div class="form-group col-md-6">
                              <input type="text" class="form-control round-style" placeholder="Name">
                           </div>
                           <div class="form-group col-md-6">
                              <input type="email" class="form-control round-style" placeholder="Email">
                           </div>
                           <div class="form-group col-md-12">
                              <input type="text" class="form-control round-style" placeholder="Subject">
                           </div>
                           <div class="form-group col-md-12">
                              <textarea  class="form-control round-style" rows="3" placeholder="Meassage"></textarea>
                           </div>
                           <div class="form-group col-md-12">
                              <input class="btn btn-default btn-radius fill-dark" type="submit" value="Send Message">
                           </div>
                  ...
                  <!-- End form style defult -->
                  <!-- form style border -->
                  <div class=" col-sm-6">
                     <div class="row">
                        <div class="col-sm-12">
                           <div class="heading-block text-left">
                              <h4 class="text-uppercase ">Style 4 Forms</h4>
                              <div class="divider"></div>
                           </div>
                        </div>
                     </div>
                     <form>
                        <div class="row">
                           <div class="form-group col-md-6">
                              <input type="text" class="form-control fill-bg" placeholder="Name">
                           </div>
                           <div class="form-group col-md-6">
                              <input type="email" class="form-control fill-bg" placeholder="Email">
                           </div>
                           <div class="form-group col-md-12">
                              <input type="text" class="form-control fill-bg" placeholder="Subject">
                           </div>
                           <div class="form-group col-md-12">
                              <textarea  class="form-control fill-bg" rows="3" placeholder="Meassage"></textarea>
                           </div>
                           <div class="form-group col-md-12">
                              <input class="btn btn-default btn-radius fill-dark" type="submit" value="Send Message">
                           </div>
               ...
               <div class="row">
                  ...
                  <div class=" col-sm-6">
                     <div class="row">
                        <div class="col-sm-12">
                           <div class="heading-block text-left">
                              <h4 class="text-uppercase ">Icon Input</h4>
                              <div class="divider"></div>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="row">
                        <div class="col-md-6 sm-mb-5">
                           <div class="row">
                              <div class="col-sm-12">
                                 <div class="heading-block text-left">
                                    <h4 class="text-uppercase ">Radio Button</h4>
                                    <div class="divider"></div>
                                 </div>
                              </div>
                           </div>
                           <div class="radio">
                              ...
                              <label for="radio1"><span class="text-gray">Radio 1</span></label>
                           </div>
                           <div class="radio">
                              <input type="radio" name="group1" id="radio2">
                              <label for="radio2"><span class="text-gray">Radio 2</span></label>
                           </div>
                           <div class="radio">
                              <input type="radio" name="group1" id="radio3">
                              <label for="radio3"><span class="text-gray">Radio 3</span></label>
                           </div>
                        </div>
                        <div class="col-md-6">
                           <div class="row">
                              <div class="col-sm-12">
                                 <div class="heading-block text-left">
                                    <h4 class="text-uppercase ">Check Box</h4>
                                    <div class="divider"></div>
                                 </div>
                              </div>
                           </div>
                           <div class="checkbox">
                              <input type="checkbox" name="group1" id="check1" checked="">
                              <label for="check1"><span class="text-gray">Check1</span></label>
                           </div>
                           <div class="checkbox">
                              <input type="checkbox" name="group1" id="check2">
                              <label for="check2"><span class="text-gray">Check2</span></label>
                           </div>
                           <div class="checkbox">
                              <input type="checkbox" name="group1" id="check3">
                              <label for="check3"><span class="text-gray">Check3</span></label>
                           </div>
                        </div>
                     </div>
                  </div>
