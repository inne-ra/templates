            ...
            <div class="container">
               <div class="row intro-title">
                  <div class="col-sm-12 text-left">
                     <h1 class="title text-white">Blockquote</h1>
                  </div>
                  <div class="col-sm-12">
                     <div class="row">
                        ...
                        <div class="col-sm-6 text-right">
                           <ul class="page-breadcrumb">
                              ...
                              <li><span class="theme-text">Blockquote</span> </li>
                           </ul>
                        </div>
                     </div>
                  </div>
               ...
               <div class="row">
                  <div class="col-sm-12">
                     <div class="heading-block text-center">
                        <h4 class="text-uppercase text-theme">Style 1</h4>
         ...
         <section class="section-pt">
            <div class="container">
               <div class="row">
                  <div class="col-sm-12">
                     <div class="heading-block text-center">
                        <h4 class="text-uppercase text-theme">Style 2</h4>
                        <div class="divider"></div>
                     </div>
                  </div>
               </div>
