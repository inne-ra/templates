                    ...
                    <ul class="nav navbar-nav navbar-right"data-in="fadeInDown"data-out="fadeOutUp">
                        ...
                        <li class="active dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="pesonal">Pesonal</a></li>
            ...
            <section class="inner-intro  small-intro dark-bg bg bg-fixed overlay jarallax"data-jarallax='{"speed": 0.2}'data-overlay-color="dark"data-overlay="2"data-bg-img="{{ asset('templates/kkr021/images/banner.jpg')}}">
                ...
                <div class="container">
                    ...
                    <div class="row intro-title">
                        ...
                        <div class="col-sm-12 text-left"><h1 class="title text-white">Post</h1></div>
                        ...
                        <div class="col-sm-12"><div class="row">
                            ...
                            <div class="col-sm-6 text-right">
                                ...
                                <ul class="page-breadcrumb">
                                    ...
                                    <li><span class="theme-text">Post</span> </li>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="heading-block text-center">
                            ...
                            <h4 class="text-uppercase text-theme">Post Style 1</h4>
                ...
                <div class="row gutter-10">
                    ...
                    <div class="col-sm-6 col-md-3">
                        ...
                        <div class="post post-over light-box">
                            ...
                            <img class="img-responsive"src="images/blog/blog1.jpg')}}"></div>
                            ...
                            <div class="post-details">
                                ...
                                <div class="post-title"><h3 class="title"><a href="#">10 construction industry</a></h3></div>

                                <div class="post-content">

                                    <p>It has survived not only five centuries,but also the leap electronic typesetting. Neque porro quisquam</p>
                    ...
                    <div class="col-sm-6 col-md-3">
                        ...
                        <div class="post post-over">
                            ...
                            <img class="img-responsive"src="images/blog/blog2.jpg')}}"></div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="heading-block text-center">
                                    ...
                                    <h4 class="text-uppercase text-theme">Post Style 2</h4>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <ul class="list-unstyled address">
                                                ...
                                                <li><i class="icon-location-pin"></i><span>121 King Street,Melbourne<br>
