            ...
            <div class="container">
               <div class="row intro-title">
                  <div class="col-sm-12 text-left">
                     <h1 class="title text-white">Tab</h1>
                  </div>
                  <div class="col-sm-12">
                     <div class="row">
                        ...
                        <div class="col-sm-6 text-right">
                           <ul class="page-breadcrumb">
                              ...
                              <li><span class="theme-text">Tab</span> </li>
                           </ul>
                        </div>
                     </div>
                  </div>
               ...
               <div class="row">
                  <div class="col-md-6 sm-mb-4">
                     <div class="row">
                        <div class="col-sm-12">
                           <div class="heading-block text-left">
                              <h4 class="text-uppercase ">Tab Style 1</h4>
                     ...
                     <div class="tab clearfix">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                           <li class="active"><a href="#tab1-1" data-toggle="tab" aria-expanded="false">Option 1</a></li>
                           <li><a href="#tab1-2" data-toggle="tab" aria-expanded="true">Option 2</a></li>
                           <li><a href="#tab1-3" data-toggle="tab">Option 3</a></li>
                           <li><a href="#tab1-4" data-toggle="tab">Option 4</a></li>
                        </ul>
                        <!-- Tab panes -->
                  ...
                  <div class="col-md-6">
                     <div class="row">
                        <div class="col-sm-12">
                           <div class="heading-block text-left">
                              <h4 class="text-uppercase ">Tab Style 2</h4>
                              <div class="divider"></div>
                           </div>
                        </div>
                     </div>
                     <div class="tab outline clearfix">
                        <!-- Nav tabs -->
                        <ul class="nav nav-tabs" role="tablist">
                           <li class="active"><a href="#tab7-1" data-toggle="tab" aria-expanded="false">Option 1</a></li>
                           <li><a href="#tab7-2" data-toggle="tab" aria-expanded="true">Option 2</a></li>
                           <li><a href="#tab7-3" data-toggle="tab">Option 3</a></li>
                           <li><a href="#tab7-4" data-toggle="tab">Option 4</a></li>
                        </ul>
                        <!-- Tab panes -->
                        <div class="tab-content">
                           <div role="tabpanel" class="tab-pane fade active in" id="tab7-1">
                              <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                           </div>
                           <div role="tabpanel" class="tab-pane fade" id="tab7-2">
                              <p>It has survived not only five centuries,but also the leap into electronic typesetting. Neque porro quisquam est,sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem.</p>
                           </div>
                           <div role="tabpanel" class="tab-pane fade" id="tab7-3">
                              <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                           </div>
                           <div role="tabpanel" class="tab-pane fade" id="tab7-4">
                              <p>It has survived not only five centuries,but also the leap into electronic typesetting. Neque porro quisquam est,sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem.</p>
                           </div>
                        </div>
                     </div>
                  </div>
                  <!-- Tabs nav outline left position -->
               </div>
            </div>
         </section>
         <!-- End Tab Style 1 -->
               ...
               <div class="row">
                  ...
                  <div class="col-md-6 sm-mb-4">
                     <div class="row">
                        <div class="col-sm-12">
                           <div class="heading-block text-left">
                              <h4 class="text-uppercase ">Tab Style 3</h4>
                              <div class="divider"></div>
                           </div>
                        </div>
                     </div>
                     <div class="tab outline rounded clearfix">
                        <!-- Nav tabs -->
                        <ul class="nav nav-tabs" role="tablist">
                           <li class="active"><a href="#tab9-1" data-toggle="tab" aria-expanded="false">Option 1</a></li>
                           <li><a href="#tab9-2" data-toggle="tab" aria-expanded="true">Option 2</a></li>
                           <li><a href="#tab9-3" data-toggle="tab">Option 3</a></li>
                           <li><a href="#tab9-4" data-toggle="tab">Option 4</a></li>
                        </ul>
                        <!-- Tab panes -->
                        <div class="tab-content">
                           ...
                           <div role="tabpanel" class="tab-pane fade" id="tab9-4">
                              <p>It has survived not only five centuries,but also the leap into electronic typesetting. Neque porro quisquam est,sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem.</p>
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="col-md-6">
                     <div class="row">
                        <div class="col-sm-12">
                           <div class="heading-block text-left">
                              <h4 class="text-uppercase ">Tab Style 4</h4>
                              <div class="divider"></div>
                           </div>
                        </div>
                     </div>
                     <div class="tab fill clearfix">
                        <!-- Nav tabs -->
                        <ul class="nav nav-tabs" role="tablist">
                           <li class="active"><a href="#tab14-1" data-toggle="tab" aria-expanded="false">Option 1</a></li>
                           <li><a href="#tab14-2" data-toggle="tab" aria-expanded="true">Option 2</a></li>
                           <li><a href="#tab14-3" data-toggle="tab">Option 3</a></li>
                           <li><a href="#tab14-4" data-toggle="tab">Option 4</a></li>
                        </ul>
                        <!-- Tab panes -->
                        <div class="tab-content">
                           <div role="tabpanel" class="tab-pane fade active in" id="tab14-1">
                              <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                           </div>
                           ...
                           <div role="tabpanel" class="tab-pane fade" id="tab14-4">
                              <p>It has survived not only five centuries,but also the leap into electronic typesetting. Neque porro quisquam est,sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem.</p>
                           </div>
                        </div>
                     </div>
               ...
               <div class="row">
                  ...
                  <div class="col-md-6 sm-mb-4">
                     <div class="row">
                        <div class="col-sm-12">
                           <div class="heading-block text-left">
                              <h4 class="text-uppercase ">Tab Style 1 Left Align</h4>
                              <div class="divider"></div>
                           </div>
                        </div>
                     </div>
                     <div class="tab vertical clearfix">
                        <!-- Nav tabs -->
                        <ul class="nav nav-tabs" role="tablist">
                           <li class=""><a href="#tab2-1" data-toggle="tab" aria-expanded="false">Option 1</a></li>
                           <li class=""><a href="#tab2-2" data-toggle="tab" aria-expanded="false">Option 2</a></li>
                           <li class="active"><a href="#tab2-3" data-toggle="tab" aria-expanded="true">Option 3</a></li>
                           <li><a href="#tab2-4" data-toggle="tab">Option 4</a></li>
                        </ul>
                        <!-- Tab panes -->
                        <div class="tab-content">
                           <div role="tabpanel" class="tab-pane fade" id="tab2-1">
                              <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. when an unknown printer took a galley of type and scrambled it to make a type specimen book.<br><br>
                           ...
                           <div role="tabpanel" class="tab-pane fade" id="tab2-2">
                              <p>It has survived not only five centuries,but also the leap into electronic typesetting. tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem.<br><br>
                                 It has survived not only five centuries,but also the leap into electronic typesetting. Neque porro quisquam est.
                              </p>
                           </div>
                           <div role="tabpanel" class="tab-pane fade active in" id="tab2-3">
                              <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. when an unknown printer took a galley of type and scrambled it to make a type specimen book.<br><br>
                                 It has survived not only five centuries,but also the leap into electronic typesetting. Neque porro quisquam est.
                              </p>
                           </div>
                  ...
                  <div class="col-md-6">
                     <div class="row">
                        <div class="col-sm-12">
                           <div class="heading-block text-left">
                              <h4 class="text-uppercase ">Tab Style 2 Left Align</h4>
                              <div class="divider"></div>
                           </div>
                        </div>
                     </div>
                     <div class="tab outline vertical clearfix">
                        <!-- Nav tabs -->
                        <ul class="nav nav-tabs" role="tablist">
                           <li class="active"><a href="#tab8-1" data-toggle="tab" aria-expanded="false">Option 1</a></li>
                           <li><a href="#tab8-2" data-toggle="tab" aria-expanded="true">Option 2</a></li>
                           <li><a href="#tab8-3" data-toggle="tab">Option 3</a></li>
                           <li><a href="#tab8-4" data-toggle="tab">Option 4</a></li>
                        </ul>
                        <!-- Tab panes -->
                        <div class="tab-content">
                           <div role="tabpanel" class="tab-pane fade active in" id="tab8-1">
                              <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. when an unknown printer took a galley of type and scrambled it to make a type specimen book.<br><br>
                                 It has survived not only five centuries,but also the leap into electronic typesetting. Neque porro quisquam est.
                              </p>
                           </div>
                           <div role="tabpanel" class="tab-pane fade" id="tab8-2">
                              <p>It has survived not only five centuries,but also the leap into electronic typesetting. tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem.<br><br>
                                 It has survived not only five centuries,but also the leap into electronic typesetting. Neque porro quisquam est.
                              </p>
                           </div>
                           <div role="tabpanel" class="tab-pane fade" id="tab8-3">
                              <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. when an unknown printer took a galley of type and scrambled it to make a type specimen book.<br><br>
                                 It has survived not only five centuries,but also the leap into electronic typesetting. Neque porro quisquam est.
                              </p>
                           </div>
                           <div role="tabpanel" class="tab-pane fade" id="tab8-4">
                              <p>It has survived not only five centuries,but also the leap into electronic typesetting. tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem.<br><br>
                                 It has survived not only five centuries,but also the leap into electronic typesetting. Neque porro quisquam est.
                              </p>
                           </div>
               ...
               <div class="row">
                  ...
                  <div class="col-md-6 sm-mb-4">
                     <div class="row">
                        <div class="col-sm-12">
                           <div class="heading-block text-left">
                              <h4 class="text-uppercase ">Tab Style 3 Left Align</h4>
                              <div class="divider"></div>
                           </div>
                        </div>
                     </div>
                     <div class="tab outline vertical rounded clearfix">
                        <!-- Nav tabs -->
                        <ul class="nav nav-tabs" role="tablist">
                           <li class="active"><a href="#tab11-1" data-toggle="tab" aria-expanded="false">Option 1</a></li>
                           <li><a href="#tab11-2" data-toggle="tab" aria-expanded="true">Option 2</a></li>
                           <li><a href="#tab11-3" data-toggle="tab">Option 3</a></li>
                           <li><a href="#tab11-4" data-toggle="tab">Option 4</a></li>
                        </ul>
                        <!-- Tab panes -->
                        <div class="tab-content">
                           <div role="tabpanel" class="tab-pane fade active in" id="tab11-1">
                              <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. when an unknown printer took a galley of type and scrambled it to make a type specimen book.<br><br>
                                 It has survived not only five centuries,but also the leap into electronic typesetting. Neque porro quisquam est.
                              </p>
                           </div>
                           <div role="tabpanel" class="tab-pane fade" id="tab11-2">
                              <p>It has survived not only five centuries,but also the leap into electronic typesetting. tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem.<br><br>
                                 It has survived not only five centuries,but also the leap into electronic typesetting. Neque porro quisquam est.
                              </p>
                           </div>
                           <div role="tabpanel" class="tab-pane fade" id="tab11-3">
                              <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. when an unknown printer took a galley of type and scrambled it to make a type specimen book.<br><br>
                                 It has survived not only five centuries,but also the leap into electronic typesetting. Neque porro quisquam est.
                              </p>
                           </div>
                           <div role="tabpanel" class="tab-pane fade" id="tab11-4">
                              <p>It has survived not only five centuries,but also the leap into electronic typesetting. tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem.<br><br>
                                 It has survived not only five centuries,but also the leap into electronic typesetting. Neque porro quisquam est.
                              </p>
                           </div>
                  ...
                  <!-- Tabs nav fill left position -->
                  <div class="col-md-6">
                     <div class="row">
                        <div class="col-sm-12">
                           <div class="heading-block text-left">
                              <h4 class="text-uppercase ">Tab Style 4 Left Align</h4>
                              <div class="divider"></div>
                           </div>
                        </div>
                     </div>
                     <div class="tab vertical fill clearfix">
                        <!-- Nav tabs -->
                        <ul class="nav nav-tabs" role="tablist">
                           <li class="active"><a href="#tab15-1" data-toggle="tab" aria-expanded="false">Option 1</a></li>
                           <li><a href="#tab15-2" data-toggle="tab" aria-expanded="true">Option 2</a></li>
                           <li><a href="#tab15-3" data-toggle="tab">Option 3</a></li>
                           <li><a href="#tab15-4" data-toggle="tab">Option 4</a></li>
                        </ul>
                        <!-- Tab panes -->
                        <div class="tab-content">
                           <div role="tabpanel" class="tab-pane fade active in" id="tab15-1">
                              <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. when an unknown printer took a galley of type and scrambled it to make a type specimen book.<br><br>
                                 It has survived not only five centuries,but also the leap into electronic typesetting. Neque porro quisquam est.
                              </p>
                           </div>
                           <div role="tabpanel" class="tab-pane fade" id="tab15-2">
                              <p>It has survived not only five centuries,but also the leap into electronic typesetting. tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem.<br><br>
                                 It has survived not only five centuries,but also the leap into electronic typesetting. Neque porro quisquam est.
                              </p>
                           </div>
                           <div role="tabpanel" class="tab-pane fade" id="tab15-3">
                              <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. when an unknown printer took a galley of type and scrambled it to make a type specimen book.<br><br>
                                 It has survived not only five centuries,but also the leap into electronic typesetting. Neque porro quisquam est.
                              </p>
                           </div>
                           <div role="tabpanel" class="tab-pane fade" id="tab15-4">
                              <p>It has survived not only five centuries,but also the leap into electronic typesetting. tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem.<br><br>
                                 It has survived not only five centuries,but also the leap into electronic typesetting. Neque porro quisquam est.
                              </p>
                           </div>
