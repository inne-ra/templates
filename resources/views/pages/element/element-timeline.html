   ...
   <html class="no-js lt-ie9 lt-ie8" lang="">
      ...
      <html class="no-js lt-ie9" lang="">
            ...
            <div class="container">
               <div class="row intro-title">
                  <div class="col-sm-12 text-left">
                     <h1 class="title text-white">Timeline</h1>
                  </div>
                  <div class="col-sm-12">
                     <div class="row">
                        ...
                        <div class="col-sm-6 text-right">
                           <ul class="page-breadcrumb">
                              ...
                              <li><span class="theme-text">Timeline</span> </li>
                           </ul>
                        </div>
                     </div>
                  </div>
         ...
         <section>
            <div class="container">
               <div class="row">
                  <div class="col-md-4 sm-mb-4">
                     <div class="heading-block text-left">
                        <h4 class="text-uppercase ">Style 1</h4>
                     ...
                     <div class="timeline clearfix">
                        <div class="timeline-panel">
                           ...
                           <div class="timeline-body">
                              <h5 class="title theme-text">Beginning Our Services</h5>
                  ...
                  <div class="col-md-4 sm-mb-4">
                     <div class="heading-block text-left">
                        <h4 class="text-uppercase ">Style 2</h4>
                        <div class="divider"></div>
                     </div>
                  ...
                  <div class="col-md-4">
                     <div class="heading-block text-left">
                        <h4 class="text-uppercase ">Style 3</h4>
                        <div class="divider"></div>
                     </div>
