...
<html class="no-js lt-ie9 lt-ie8 lt-ie7" lang="">
   ...
   <html class="no-js lt-ie9 lt-ie8" lang="">
      ...
      <html class="no-js lt-ie9" lang="">
            ...
            <div class="container">
               <div class="row intro-title">
                  <div class="col-sm-12 text-left">
                     <h1 class="title text-white">Counters</h1>
                  </div>
                  <div class="col-sm-12">
                     <div class="row">
                        ...
                        <div class="col-sm-6 text-right">
                           <ul class="page-breadcrumb">
                              ...
                              <li><span class="theme-text">Counters</span> </li>
                           </ul>
                        </div>
                     </div>
                  </div>
            ...
            <div class="container">
               <div class="row">
                  ...
                  <div class="col-sm-3 col-xs-6 col-xx-12 mb-3">
                     <div class="counter text-center">
                        <div class="counter-icon">
                           <i class="icon-question icons theme-text"></i>
                        </div>
                  ...
                  <div class="col-sm-3 col-xs-6 col-xx-12 mb-3">
                     <div class="counter text-center">
                        <div class="counter-icon">
                           <i class="icon-badge icons theme-text"></i>
                        </div>
                        <div class="counter-info">
                           <span class="timer" data-to="25000" data-speed="10000">25000</span>
                           <label>Awords</label>
                  ...
                  <div class="col-sm-3 col-xs-6 col-xx-12 mb-3">
                     <div class="counter text-center">
                        <div class="counter-icon">
                           <i class="icon-check icons theme-text"></i>
                        </div>
                        <div class="counter-info">
                           <span class="timer" data-to="25000" data-speed="10000">25000</span>
                  ...
                  <div class="col-sm-3 col-xs-6 col-xx-12 mb-3">
                     <div class="counter text-center">
                        <div class="counter-icon">
                           <i class="icon-emotsmile icons theme-text"></i>
                        </div>
                        <div class="counter-info">
                           <span class="timer" data-to="25000" data-speed="10000">25000</span>
         ...
         <section class="theme-bg pb-7 sm-pb-4 xs-pb-0">
            <div class="container">
               <div class="row">
                  <div class="col-sm-3 col-xs-6 col-xx-12 mb-3">
         ...
         <!-- End Counter bottome line -->
         <!-- Counter icon position left -->
         <section class="grey-bg pb-7 sm-pb-4 xs-pb-0">
            <div class="container">
               <div class="row">
                  <div class="col-sm-3 col-xs-6 col-xx-12 mb-3">
         ...
         <!-- End Counter icon position left -->
         <!-- Counter icon position right -->
         <section class="dark-bg pb-7 sm-pb-4 xs-pb-0">
            <div class="container">
               <div class="row">
                  <div class="col-sm-3 col-xs-6 col-xx-12 mb-3">
                     <div class="counter icon-position-right">
                        <div class="counter-info">
                           <span class="timer" data-to="25000" data-speed="10000">25000</span>
                           <label>Questions Answered</label>
                        </div>
         ...
         <!-- End Counter icon position right -->
         <!-- Counter fancy -->
         <section class="pb-7 sm-pb-4 xs-pb-0">
            <div class="container">
               <div class="row">
